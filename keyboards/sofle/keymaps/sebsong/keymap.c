...
[RAISE] = LAYOUT(
  ...
  _______,  KC_INS,  KC_PRV_TAB,   KC_UP,  KC_NXT_TAB, XXXXXXX,                        KC_PGUP, KC_MS_BTN1, KC_MS_U, KC_MS_BTN2,_______, KC_BSPC,
  KC_SLEP, KC_LALT,  KC_LEFT,  KC_DOWN,  KC_RGHT, KC_CAPS,                       KC_PGDN,  KC_MS_L, KC_MS_D, KC_MS_R,  KC_DEL, KC_BSPC,
